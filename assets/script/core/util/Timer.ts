...
class Timer {
    ...
    /** 回调列表 */
    private _callbackList: TimerCallback[];
    /** 当前数 */
    ...
    /** 最小触发间隔(ms) */
    private static readonly MIN_INTERVAL: number = 16;
    /** 运行时长(ms) */
    private _runTime: number;
    /** 自动回收间隔(ms) */
    private static readonly RECYCLE_INTERVAL: number = 6000;
